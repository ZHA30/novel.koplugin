-- Generated from Python html.entities.html5, based on the WHATWG HTML5 named character references.
-- Keep this module data-only: decoding behavior lives in novel.catalog.shared.format.
local entities = {
    ["AElig"] = "\u{C6}",
    ["AElig;"] = "\u{C6}",
    ["AMP"] = "\u{26}",
