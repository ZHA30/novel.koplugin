...
ExploreService.__index = ExploreService
...
function ExploreService.groups(source)
...
function ExploreService:new(options)
    options = options or {}
    return setmetatable({
...
function ExploreService:explore(source, group, options)
    options = options or {}
    ...
    local spec = RequestSupport.requestSpec(source, group.url, options, {
...
function ExploreService.run(source, group, options)
    return ExploreService:new(options):explore(source, group, options)
end
